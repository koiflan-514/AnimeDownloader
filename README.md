...
- 标签升级：查看器显示图片全部标签（热门标签带中文译名与类别圆点，点击 chip 直接跳转到
  该标签的画廊视图）；标签输入复选框智能提示（按热度联想、显示中文译名 / 原名 / 帖子数、
  类别圆点，勾选即加入搜索，并给出相关标签推荐）；内嵌 5000 条热门标签中英对照表
- 查看器增值功能：复制图片直链、SauceNAO / IQDB 以图搜图一键跳转
...
- 批量下载整个画廊到指定文件夹（并行下载提速、带进度与取消，自动跳过已存在文件）
